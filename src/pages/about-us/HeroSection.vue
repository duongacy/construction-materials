    ...
    <div class="overflow-hidden">
      <TheContainer class="pb-32 pt-36 sm:pt-60 lg:pt-32">
        <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
          ...
          >
            <div
              v-if="!!heroSectionData?.backgrounds[0]"
              class="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80"
            >
              <div class="relative">
                <img
                  :src="VITE_API_URL + heroSectionData?.backgrounds[0].url"
                  alt=""
            ...
            <div
              v-if="!!heroSectionData?.backgrounds[1] || !!heroSectionData?.backgrounds[2]"
              class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36"
            >
              <div v-if="!!heroSectionData?.backgrounds[1]" class="relative">
                <img
                  :src="VITE_API_URL + heroSectionData?.backgrounds[1].url"
                  alt=""
                  class="aspect-[2/3] w-full rounded-xl bg-neutral-900/5 object-cover shadow-lg"
                />
                <div
              ...
              <div v-if="!!heroSectionData?.backgrounds[2]" class="relative">
                <img
                  :src="VITE_API_URL + heroSectionData?.backgrounds[2].url"
                  alt=""
                  class="aspect-[2/3] w-full rounded-xl bg-neutral-900/5 object-cover shadow-lg"
                />
                <div
            ...
            <div
              v-if="!!heroSectionData?.backgrounds[3] || !!heroSectionData?.backgrounds[4]"
              class="w-44 flex-none space-y-8 pt-32 sm:pt-0"
            >
              <div v-if="!!heroSectionData?.backgrounds[3]" class="relative">
                <img
                  :src="VITE_API_URL + heroSectionData?.backgrounds[3].url"
                  alt=""
                  class="aspect-[2/3] w-full rounded-xl bg-neutral-900/5 object-cover shadow-lg"
                />
                <div
              ...
              <div v-if="!!heroSectionData?.backgrounds[4]" class="relative">
                <img
                  :src="VITE_API_URL + heroSectionData?.backgrounds[4].url"
                  alt=""
                  class="aspect-[2/3] w-full rounded-xl bg-neutral-900/5 object-cover shadow-lg"
                />
                <div
