<template>
  <TheContainer class="mt-32 sm:mt-40">
    ...
    >
      ...
      >
        <p class="flex-none text-3xl font-bold tracking-tight text-neutral-900">250k</p>
        <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
          <p class="text-lg font-semibold tracking-tight text-neutral-900">Users on the platform</p>
      ...
      >
        <p class="flex-none text-3xl font-bold tracking-tight text-primary-foreground">401,093</p>
        <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
